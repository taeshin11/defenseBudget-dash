...
export default async function NATODefenseSpendingPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <div className="space-y-10">
      ...
      <section className="rounded-xl bg-accent-navy-light p-6 text-center">
        ...
        <Link
          href={`${prefix}/compare?countries=${compareQuery}&metric=pct_gdp`}
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Link href={`${prefix}/us-vs-china-military-spending`} className="group rounded-xl bg-white p-5 shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5">
          ...
          <Link href={`${prefix}/top-military-spenders`} className="group rounded-xl bg-white p-5 shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5">
          ...
          <Link href={`${prefix}/defense-spending-by-region`} className="group rounded-xl bg-white p-5 shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5">
