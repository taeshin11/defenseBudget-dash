...
function ComparePageInner() {
  ...
  const METRIC_OPTIONS: { key: Metric; label: string }[] = [
    { key: "spending", label: dict.compare.totalSpending },
    { key: "pct_gdp", label: dict.compare.pctGDP },
    { key: "personnel", label: dict.compare.personnel },
  ];
  ...
  const handleCompare = useCallback(() => {
    ...
    router.replace(`${prefix}/compare?${params.toString()}`, { scroll: false });
      ...
      <div className="flex-1 space-y-8">
        ...
        {chartData.length > 0 ? (
          <div className="rounded-xl bg-white p-6 shadow-md">
            ...
            <BarChartComponent
              data={chartData}
              metric={METRIC_OPTIONS.find((m) => m.key === metric)!.label}
          ...
          <div className="rounded-xl bg-white p-12 shadow-md text-center">
            ...
            <p className="mt-4 text-lg font-medium text-text-secondary">
              {dict.compare.selectToStart}
            </p>
            <p className="mt-2 text-sm text-text-muted">
              {dict.compare.orTryPopular}
            </p>
