    ...
    <div className="space-y-10">
      ...
      <nav aria-label="Breadcrumb" className="text-sm text-text-secondary">
        <ol className="flex items-center gap-1.5">
          <li>
            <Link href="/" className="hover:text-accent-navy transition-colors duration-200">
              Home
            </Link>
          </li>
          <li>/</li>
          <li>
            <Link href="/rankings" className="hover:text-accent-navy transition-colors duration-200">
              Rankings
            </Link>
          </li>
          <li>/</li>
      ...
      <section className="rounded-xl bg-accent-navy-light p-6 text-center">
        ...
        <Link
          href={`/compare?countries=${compareQuery}`}
